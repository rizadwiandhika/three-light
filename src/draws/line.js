...
export async function line() {
	...
	// 1. Next thing we will do is define a material. For lines we have to use LineBasicMaterial or LineDashedMaterial.
	// create a blue LineBasicMaterial
	const material = new THREE.LineBasicMaterial({ color: 0x0000ff })

	// 2. After material we will need a geometry with some vertices:
	const points = []
